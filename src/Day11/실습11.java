...
public class 실습11 {
    public static void main(String[] args) {
        ...
        abcde.remove(2);                // 2번 인덱스의 요소 삭제
        System.out.println( abcde );    // 리스트 출력
        ...
        programming.add("자바"); programming.add("파이썬"); programming.add("C++");
        programming.add( 1, "자바스크립트");      // 1번 인덱스에 "자바스크립트" 삽입
        ...
        for ( ; ; ){
            ...
            System.out.print("입력 : ");      String input = scan.next(); // 문자열을 입력받고
            if ( input.equals("종료") ){              // 종료를 입력하면
                System.out.println( stringInput );   // 리스트의 모든 내용 출력하고
                break;                               // 프로그램 종료
            } else {                                 // 종료가 아니라면
                stringInput.add( input );            // 리스트에 순서대로 저장
            } // if end
        } // for end
        ...
        subject.set( 1, "영어");          // 1번 인덱스의 값을 "영어"로 수정
